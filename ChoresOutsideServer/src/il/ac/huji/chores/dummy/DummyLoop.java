...
public class DummyLoop {
	...
	public static void test(){
		...
		chores.add(new ApartmentChore("washing dishes", new Date(2013-1900,10, 12), new Date(2013-1900,10, 16), 3));
		chores.add(new ApartmentChore("washing dishes", new Date(2013-1900,11, 5), new Date(2013-1900,11, 11), 5));
